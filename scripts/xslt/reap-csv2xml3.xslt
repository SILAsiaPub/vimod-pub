...
<xsl:include href="inc-file2uri.xslt"/>
      ...
      <xsl:param name="sourcetext1"/>
      <xsl:param name="sourcetext2"/>
      <xsl:param name="sourcetext3"/>
      <xsl:param name="group" select="'metadata'"/>
      <xsl:variable name="csv1" select="unparsed-text(f:file2uri($sourcetext1))"/>
      <xsl:variable name="csv2" select="unparsed-text(f:file2uri($sourcetext2))"/>
      <xsl:variable name="csv3" select="unparsed-text(f:file2uri($sourcetext3))"/>
      <xsl:template match="/">
            <database>
