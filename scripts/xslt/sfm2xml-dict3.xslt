...
<xsl:param name="subtitle-row" select="3"/>
<xsl:param name="table-header-row" select="4"/>
            ...
            <xsl:for-each select="$tableline">
                  ...
                  <xsl:choose>
                        ...
                        <xsl:when test="position() = 2">
                          ...
                          <xsl:when test="position() = number($subtitle-row)"> 
                          ...
                          <xsl:when test="position() = number($table-header-row)"> 
