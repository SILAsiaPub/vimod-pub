...
<!--
    #############################################################
    # Name:        usx-chap-grp2simplehtmlscr5.xslt
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0" xmlns:f="myfunctions" exclude-result-prefixes="f">
      ...
      <xsl:template name="writehtmlchapterindex">
            ...
            <xsl:result-document href="{$filenameuri}" format="html5">
                  ...
                  <xsl:result-document href="{$filenameuri}" format="html5">
                        <html lang="{$iso}">
                              <xsl:call-template name="head">
                                    ...
                                    <xsl:with-param name="simplehtmlscr" select="'true'"/>
                              </xsl:call-template>
                              <body dir="{$textdir}">
                              <header class="bar">
      ...
      <xsl:template match="data" mode="bookindex">
            ...
            <xsl:result-document href="{$filename}" format="html5">
                  <xsl:text disable-output-escaping='yes'>&lt;!DOCTYPE html&gt;&#10;</xsl:text>
                  <html lang="{$iso}">
                        <xsl:call-template name="html-head">
      ...
      <xsl:template name="writestarterpage">
            ...
            <xsl:result-document href="{$starterindex}" format="html5">
                  <xsl:text disable-output-escaping='yes'>&lt;!DOCTYPE html&gt;&#10;</xsl:text>
                  <html lang="{$iso}">
                        <head>
                              <title>
