...
<!--
    ...
    ################################################################
-->
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:f="myfunctions" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
                                                            ...
                                                            <xsl:when test="string-length(.) gt 0">
                                                                  ...
                                                                  <xsl:element name="field">
                                                                        ...
                                                                        <xsl:attribute name="xsi:nil">
                                                                              <xsl:if test="not(string-length($field[$pos]) gt 0)">
